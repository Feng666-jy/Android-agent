const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/LoginView-c-6g-uJm.js',
      'assets/user-DY2KCaFn.js',
      'assets/request-DT7itpYf.js',
      'assets/GlassCard-CWG_Ebya.js',
      'assets/GlassCard-D1XDQemc.css',
      'assets/LoginView-Lk-Q_Lck.css',
      'assets/RegisterView-BpR_PlPs.js',
      'assets/RegisterView-6skarRRI.css',
      'assets/AiHomePage-CDi32GhY.js',
      'assets/model-C5mwqF1A.js',
      'assets/BottomToolbar-CYol9ShB.js',
      'assets/BottomToolbar-COviZtNj.css',
      'assets/agent-Bh8Q5wlv.js',
      'assets/conversation-CUUchlMZ.js',
      'assets/AiHomePage-Ctq15q1V.css',
      'assets/PersonalCenter-BbZm-29_.js',
      'assets/PersonalCenter-6XLKTbtg.css',
      'assets/ProfileView-BcSL4iJz.js',
      'assets/ProfileView-Dcvpn_sH.css',
      'assets/TabLayout-BFUb_gJ7.js',
      'assets/TabLayout-BrDXqkZV.css',
      'assets/SearchView-DLT8ZMrS.js',
      'assets/SearchView-C2EJGDjK.css',
      'assets/ImageView-DWiB0MKC.js',
      'assets/ImageView-ClPpmMnD.css',
      'assets/FilesView-Ci7MhYbH.js',
      'assets/FilesView-CJ_PR2o3.css',
      'assets/CodeView-CuLWRC1-.js',
      'assets/CodeView-BE8ZNmL_.css',
      'assets/HistoryView-C2mh_7xJ.js',
      'assets/HistoryView-ah7FSUUg.css',
      'assets/SettingsView-DN0qyeYT.js',
      'assets/SettingsView-BAc2jLrv.css',
      'assets/ProviderList-DzdwOIqV.js',
      'assets/provider-Dii240zR.js',
      'assets/provider-CPPopWTb.js',
      'assets/ProviderList-cIbvtxqL.css',
      'assets/ProviderForm-DeOUi5I7.js',
      'assets/ProviderForm--mkgfX5U.css',
      'assets/ProviderDetail-D2tGaOIM.js',
      'assets/ProviderDetail-DKeIWUxo.css',
      'assets/ModelManager-DDqR_cYL.js',
      'assets/ModelManager-DLdlfxtR.css',
      'assets/ToolManager-Bi8_6aUs.js',
      'assets/ToolManager-CDZ506jM.css',
      'assets/DeviceManager-D5aL3IdU.js',
      'assets/DeviceManager-T_jQqLra.css',
      'assets/AiResourcesView-Da7bM09e.js',
      'assets/AiResourcesView-Kh7A7eTs.css',
      'assets/OrgView-CcDhgTXw.js',
      'assets/OrgView-B_HL7hX7.css',
      'assets/ApiKeysView-CuNVZeCH.js',
  ...
  oh = Rw({
    ...
    routes: [
      { path: '/', redirect: '/home' },
      {
        ...
        name: 'Login',
        component: () =>
          Ke(() => import('./LoginView-c-6g-uJm.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5])),
      ...
      },
      {
        ...
        name: 'Register',
        component: () =>
          Ke(() => import('./RegisterView-BpR_PlPs.js'), __vite__mapDeps([6, 1, 2, 3, 4, 7])),
      ...
      },
      {
        ...
        name: 'PersonalCenter',
        component: () =>
          Ke(() => import('./PersonalCenter-BbZm-29_.js'), __vite__mapDeps([15, 12, 2, 13, 9, 16])),
      ...
      },
      {
        ...
        name: 'Profile',
        component: () =>
          Ke(() => import('./ProfileView-BcSL4iJz.js'), __vite__mapDeps([17, 1, 2, 18])),
        meta: { title: '设置', requiresAuth: !0 }
      },
      {
        path: '/workspace',
        component: () =>
          Ke(() => import('./TabLayout-BFUb_gJ7.js'), __vite__mapDeps([19, 10, 11, 20])),
        meta: { requiresAuth: !0 },
        ...
        children: [
          {
            ...
            name: 'search',
            component: () =>
              Ke(() => import('./SearchView-DLT8ZMrS.js'), __vite__mapDeps([21, 22])),
            meta: { title: '搜索' }
          },
          {
            path: 'image',
            name: 'image',
            component: () => Ke(() => import('./ImageView-DWiB0MKC.js'), __vite__mapDeps([23, 24])),
            meta: { title: '绘图' }
          },
          {
            path: 'files',
            name: 'files',
            component: () => Ke(() => import('./FilesView-Ci7MhYbH.js'), __vite__mapDeps([25, 26])),
            meta: { title: '文件' }
          },
          {
            path: 'code',
            name: 'code',
            component: () => Ke(() => import('./CodeView-CuLWRC1-.js'), __vite__mapDeps([27, 28])),
            meta: { title: '代码' }
          },
          {
            path: 'history',
            name: 'history',
            component: () =>
              Ke(() => import('./HistoryView-C2mh_7xJ.js'), __vite__mapDeps([29, 12, 2, 30])),
            meta: { title: '历史' }
          },
          {
            path: 'settings',
            name: 'settings',
            component: () =>
              Ke(() => import('./SettingsView-DN0qyeYT.js'), __vite__mapDeps([31, 32])),
            meta: { title: '设置' },
            children: [
              {
                path: 'providers',
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderList-DzdwOIqV.js'),
              ...
              },
              {
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderForm-DeOUi5I7.js'),
              ...
              },
              {
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderDetail-D2tGaOIM.js'),
              ...
              },
              {
                ...
                name: 'model-manager',
                component: () =>
                  Ke(() => import('./ModelManager-DDqR_cYL.js'), __vite__mapDeps([41, 9, 2, 42])),
                meta: { title: '模型管理' }
              },
              {
                path: 'tools',
                name: 'tool-manager',
                component: () =>
                  Ke(() => import('./ToolManager-Bi8_6aUs.js'), __vite__mapDeps([43, 2, 44])),
                meta: { title: '工具管理' }
              },
              {
                path: 'devices',
                name: 'device-manager',
                component: () =>
                  Ke(() => import('./DeviceManager-D5aL3IdU.js'), __vite__mapDeps([45, 2, 46])),
                meta: { title: '设备连接' }
              },
              {
                path: 'ai-resources',
                ...
                component: () =>
                  Ke(
                    () => import('./AiResourcesView-Da7bM09e.js'),
              ...
              },
              {
                ...
                name: 'org-manager',
                component: () =>
                  Ke(() => import('./OrgView-CcDhgTXw.js'), __vite__mapDeps([49, 2, 1, 50])),
                meta: { title: '组织管理' }
              },
              {
                path: 'api-keys',
                name: 'api-keys',
                component: () =>
                  Ke(() => import('./ApiKeysView-CuNVZeCH.js'), __vite__mapDeps([51, 2, 52])),
                meta: { title: 'API Key' }
              }
            ]
          }
