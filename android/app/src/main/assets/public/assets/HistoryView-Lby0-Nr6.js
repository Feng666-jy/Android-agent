...
import { a as k } from './agent-BmSbCKqF.js'
...
const Q = { class: 'history' },
  ...
  ve = ['onClick'],
  fe = ['disabled'],
  ye = { key: 1, class: 'history__end' },
  pe = { class: 'detail-sheet' },
  ...
  De = { class: 'detail-sheet__error' },
  Te = { class: 'detail-sheet__section' },
  ze = { key: 0, class: 'detail-sheet__none' },
  Ae = { class: 'detail-sheet__tool-row' },
  Me = { class: 'detail-sheet__tool-ms' },
  Ee = { class: 'detail-sheet__args' },
  Je = { key: 0, class: 'detail-sheet__output' },
  Le = { class: 'detail-sheet__section' },
  Ne = { class: 'detail-sheet__msg-row' },
  Ie = { class: 'detail-sheet__msg-time' },
  ...
  He = P({
    ...
    setup(Re) {
      ...
      function M() {
        d.value.length >= f.value || y.value || ((g.value += 1), w(!0))
      }
      function E() {
        ;((g.value = 1), w(!1))
      }
      ...
      return (
        U(() => {
          ;(w(!1), window.addEventListener('keydown', D))
        }),
        Y(() => {
              ...
              ? (n(),
                o('div', W, [
                  ...
                  o(
                    h,
                    null,
                    p(3, t => e('div', { key: t, class: 'history__skeleton' })),
                    64
                  ))
                ]))
              : d.value.length === 0
                    ...
                    [
                      e('div', Z, [
                        e('label', j, [
                          e(
                            'input',
                            { type: 'checkbox', checked: B.value, onChange: L },
                            null,
                            40,
                            ee
                          ),
                              ...
                              o(
                                ...
                                [
                                  ...
                                  e('div', ue, [
                                    ...
                                    e(
                                      'button',
                                      { class: 'run-card__del', onClick: _ => N(t.id) },
                                      '删除',
                                      8,
                                      ve
                                    )
                      ...
                      d.value.length < f.value
                        ? (n(),
                          o(
                            'button',
                            { key: 0, class: 'history__more', disabled: y.value, onClick: M },
                            l(y.value ? '加载中...' : '加载更多'),
                            9,
                            fe
                          ))
                        : (n(), o('p', ye, '已加载全部 ' + l(f.value) + ' 条', 1))
                    ],
                    64
                  )),
            b.value
              ? (n(),
                o('div', { key: 3, class: 'detail-overlay', onClick: z(x, ['self']) }, [
                  e('div', pe, [
                                            ...
                                            o(
                                              ...
                                              p(
                                                ...
                                                T => (
                                                  ...
                                                  o(
                                                    'div',
                                                    { key: T.id, class: 'detail-sheet__msg-tool' },
                                                    [e('code', null, l(T.name), 1)]
                                                  )
                                                )
                                              ),
