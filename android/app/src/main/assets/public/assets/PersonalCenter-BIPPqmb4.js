...
import { a as re } from './agent-BmSbCKqF.js'
import { u as ce } from './conversation-CQUa4R_f.js'
import { u as de } from './model-DfDNvLOK.js'
...
const be = M(xe, [
  ...
  je = { key: 2, class: 'pc-list' },
  ze = ['onClick'],
  Ie = { class: 'pc-task__main' },
  Ne = { class: 'pc-task__head' },
  Ae = { class: 'pc-task__title' },
  ...
  Ge = { class: 'pc-task__head' },
  Qe = { class: 'pc-task__title' },
  ...
  Ze = N({
    ...
    setup($) {
      ...
      function U() {
        i.value.length >= w.value || m.value || v.value || ((C.value += 1), j(!0))
      }
      function G() {
        ;((C.value = 1), j(!1))
      }
      ...
      return (
        te(() => {
          ;(j(!1), h.models.length === 0 && h.fetchModels({ page: 1, pageSize: 50 }))
        }),
        se(t, a => {
        ...
        (a, s) => (
          ...
          l('div', Se, [
            ...
            e(
              'main',
              { class: 'personal-center__content', onScrollPassive: Q },
              [
                v.value
                  ? (n(),
                    l('div', Me, [
                      ...
                      l(
                        z,
                        null,
                        I(4, o => e('div', { class: 'pc-skeleton', key: o })),
                        64
                      ))
                    ]))
                  : K.value
