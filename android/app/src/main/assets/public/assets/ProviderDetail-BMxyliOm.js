...
import { u as ee } from './provider-CbtpCNgc.js'
import './provider-kt362Y4q.js'
...
const te = { class: 'provider-detail' },
  ...
  De = { key: 0, class: 'provider-detail__models-empty' },
  Ee = { key: 1, class: 'provider-detail__models-list' },
  He = { class: 'model-item__info' },
  Me = { class: 'model-item__name-row' },
  Le = { class: 'model-item__name' },
  Pe = { key: 0, class: 'model-item__tag model-item__tag--default' },
  je = { key: 1, class: 'model-item__tag model-item__tag--fav' },
  Re = { class: 'model-item__id' },
  Te = { key: 0, class: 'model-item__caps' },
  Se = { class: 'model-item__meta' },
  Ie = { key: 0 },
  Ue = { class: 'mpop__sheet' },
  Fe = { class: 'mpop__header' },
  Ve = { key: 0, class: 'mpop__loading' },
  ze = { key: 1, class: 'mpop__empty' },
      ...
      async function R() {
        if (r.value) {
          ...
          try {
            ...
            if (s) {
              const t = N(s.status) + ' 耗时 ' + s.latencyMs + 'ms'
              g(t)
            }
          } finally {
            k.value = !1
        ...
        return (
          ...
          i('div', te, [
            e('header', { class: 'provider-detail__header' }, [
              e('button', { class: 'provider-detail__back', 'aria-label': '返回', onClick: D }, [
                ...(t[2] ||
                  (t[2] = [
                    e(
                      'svg',
                ...
                : n.value
                      ...
                      [
                        e('section', le, [
                          ...
                          e('div', fe, [
                            ...
                            e('span', ke, a(I(n.value.lastCheckedAt)), 1)
                          ]),
                          e('div', ye, [
                            e(
                              'button',
                                  ...
                                  y(
                                    ...
                                    o => (
                                      ...
                                      i('div', { key: o.id, class: 'model-item' }, [
                                        e('div', He, [
                                          e('div', Me, [
                                            e('span', Le, a(o.displayName || o.modelName), 1),
                                            o.isDefault ? (l(), i('span', Pe, '默认')) : p('', !0),
                                            o.isFavorite ? (l(), i('span', je, '收藏')) : p('', !0)
                                          ]),
                                          e('span', Re, a(o.modelName), 1),
                                          A(o.capabilities).length
                                            ? (l(),
                                              i('div', Te, [
                                                (l(!0),
                                                i(
                                          ...
                                          e('div', Se, [
                                            ...
                                            o.temperature != null
                                              ? (l(), i('span', Ie, '温度: ' + a(o.temperature), 1))
                                              : p('', !0)
                                          ])
                                        ])
                                      ])
                  ...
                  : (l(),
                    i('div', ie, [
                      ...
                      e('button', { class: 'provider-detail__empty-btn', onClick: D }, '返回列表')
                    ]))
            ]),
            $(
              O,
