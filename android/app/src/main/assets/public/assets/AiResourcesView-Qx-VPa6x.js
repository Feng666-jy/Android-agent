...
import { p as N } from './provider-DkfW0_eM.js'
const F = {
    summary() {
  ...
  j = { class: 'ai-res__usage-cell' },
  z = { class: 'ai-res__usage-num' },
  W = { class: 'ai-res__usage-label' },
    ...
    setup(C) {
      ...
      return (e, r) => (
        ...
        i('div', O, [
          ...
          d.value ? (o(), i('div', B, t(d.value), 1)) : p('', !0),
              ...
              i(
                ...
                [
                  s('section', G, [
                    ...
                    s('div', Y, [
                      s('div', j, [
                        s('span', z, t(n.value.usage.today.requests), 1),
                        s(
                          'span',
                          W,
                                      ...
                                      ? (o(),
                                        i(
                                          ...
                                          [
                                            ...
                                            s(
                                              'button',
                                              { class: 'ai-res__btn-danger', onClick: _ => L(a) },
                                              '删除',
                                              8,
                                              ps
                                            )
                  ...
                  s('section', bs, [
                    s('div', Cs, [
                      ...
                      s('button', { class: 'ai-res__btn-ghost', onClick: K }, '管理模型')
                    ]),
                                    ...
                                    s('div', Ms, [
                                      ...
                                      i(
                                        ...
                                        m(
                                          ...
                                          _ => (
                                            o(),
                                            i('span', { key: _, class: 'ai-res__tag' }, t(x(_)), 1)
                                          )
                                        ),
                                        128
                                      )),
  ...
  Ds = S(Ks, [['__scopeId', 'data-v-e6d1f8d2']])
