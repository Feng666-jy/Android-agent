...
import { r as g } from './request-eyLhzUlJ.js'
import { u as Q } from './user-Pp4P9df0.js'
const w = {
    list() {
    ...
    setup(l) {
      ...
      async function N() {
        if (o.value && window.confirm(`确认解散组织「${o.value.name}」？此操作不可恢复。`))
          try {
            ;(await w.remove(o.value.id), h('组织已解散'), L())
          } catch (a) {
            ...
            ? o.value
              ? (i(),
                r(
                  ...
                  [
                    t('div', ue, [
                      t('button', { class: 'org-view__btn-ghost', onClick: L }, '← 返回列表'),
                      t(
                        'div',
                        { class: A(['org-view__badge', `is-${I.value ?? 'member'}`]) },
                        u(O[I.value ?? 'member']),
                        3
                      )
                    ]),
                      ...
                      t('div', _e, [
                        b.value
                          ? (i(),
                            r(
                              'button',
                              { key: 0, class: 'org-view__btn-primary', onClick: T },
                              ' 保存修改 '
                            ))
                          : v('', !0),
                        R.value
                          ...
                          j(
                            ...
                            s => (
                              ...
                              r('li', { key: s.id, class: 'org-view__item' }, [
                                t('div', he, [
                                  t('div', ye, [
                                    F(u(s.username ?? `用户 #${s.userId}`) + ' ', 1),
                                    t(
                                      'span',
                                      { class: A(['org-view__badge', `is-${s.role}`]) },
                                      u(O[s.role] ?? s.role),
                                      3
                                    )
                                  ]),
                    ...
                    ? (i(),
                      r('div', ee, [
                        ...
                        f(
                          ...
                          [[M, c.value.description]]
                        ),
                        t('button', { class: 'org-view__btn-primary', onClick: S }, '创建')
                      ]))
                    : v('', !0),
                  t('ul', te, [
                    (i(!0),
                    r(
                      ...
                      j(
                        ...
                        s => (
                          ...
                          r(
                            'li',
                            { key: s.id, class: 'org-view__item', onClick: D => C(s) },
                            [
                              t('div', ae, [
                                t('div', oe, u(s.name), 1),
                                t('div', re, u(s.description || '暂无描述'), 1),
                                t('div', ie, [
                                  F(' 创建于 ' + u(s.createdAt.slice(0, 10)) + ' ', 1),
                                  s.status !== 'active'
  ...
  Ue = K($e, [['__scopeId', 'data-v-a0d38d44']])
