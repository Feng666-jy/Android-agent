const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/index-gd_PtegP.js', 'assets/index-CprlDezj.css'])
) => i.map(i => d[i])
import {
  d as I,
  c as _,
...
import { m as j, u as me } from './model-C5mwqF1A.js'
import { B as fe } from './BottomToolbar-CYol9ShB.js'
import { m as ke, a as R } from './agent-Bh8Q5wlv.js'
import { u as ge } from './conversation-CUUchlMZ.js'
    ...
    setup(c) {
      ...
      function T(m) {
        if (!l.value) {
          ve(
            async () => {
              const { showToast: C } = await import('./index-gd_PtegP.js').then(y => y.N)
              return { showToast: C }
            },
            __vite__mapDeps([0, 1])
