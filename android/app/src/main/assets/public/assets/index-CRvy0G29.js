const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/LoginView-CY8Pgu3B.js',
      'assets/user-BQbxlVMF.js',
      'assets/user-DuiVKeQ2.js',
      'assets/request-CrdghNby.js',
      'assets/GlassCard-aWEFUVVZ.js',
      'assets/GlassCard-D1XDQemc.css',
      'assets/LoginView-Lk-Q_Lck.css',
      'assets/RegisterView-D-CRtYk6.js',
      'assets/RegisterView-6skarRRI.css',
      'assets/AiHomePage-h-_giYqD.js',
      'assets/model-CohEiPKl.js',
      'assets/BottomToolbar-BK0lvsz6.js',
      'assets/BottomToolbar-COviZtNj.css',
      'assets/agent-Boi5S9ZI.js',
      'assets/conversation-CDR0OpKV.js',
      'assets/AiHomePage-Ctq15q1V.css',
      'assets/PersonalCenter-z1nDyoP9.js',
      'assets/PersonalCenter-6XLKTbtg.css',
      'assets/ProfileView-D6tgGxdw.js',
      'assets/ProfileView-Dcvpn_sH.css',
      'assets/TabLayout-BfA-3VPv.js',
      'assets/TabLayout-BrDXqkZV.css',
      'assets/SearchView-gVr_iwJR.js',
      'assets/SearchView-C2EJGDjK.css',
      'assets/ImageView-glHrQP7m.js',
      'assets/ImageView-ClPpmMnD.css',
      'assets/FilesView-f7KoC1Gh.js',
      'assets/FilesView-CJ_PR2o3.css',
      'assets/CodeView-C0GKzrp0.js',
      'assets/CodeView-BE8ZNmL_.css',
      'assets/HistoryView-EWaoPA11.js',
      'assets/HistoryView-ah7FSUUg.css',
      'assets/SettingsView-CXJyO5fs.js',
      'assets/SettingsView-kYnrmVM4.css',
      'assets/ProviderList-BwZja76Y.js',
      'assets/provider-HAXSra3I.js',
      'assets/provider-r4aRWO2Y.js',
      'assets/ProviderList-cIbvtxqL.css',
      'assets/ProviderForm-BcjiQP0m.js',
      'assets/ProviderForm--mkgfX5U.css',
      'assets/ProviderDetail-B5Ot1rbI.js',
      'assets/ProviderDetail-DKeIWUxo.css',
      'assets/ModelManager-6FgyDDnO.js',
      'assets/ModelManager-DLdlfxtR.css',
      'assets/ToolManager-UgY28yN4.js',
      'assets/ToolManager-CDZ506jM.css',
      'assets/DeviceManager-CBen3s4w.js',
      'assets/DeviceManager-D-9EvYzr.css',
      'assets/AiResourcesView-CjCBDN26.js',
      'assets/AiResourcesView-Kh7A7eTs.css',
      'assets/OrgView-CxYy2a63.js',
      'assets/OrgView-B_HL7hX7.css',
      'assets/ApiKeysView-CnmwbuDo.js',
  ...
  oh = Rw({
    ...
    routes: [
      { path: '/', redirect: '/home' },
      {
        ...
        name: 'Login',
        component: () =>
          Ke(() => import('./LoginView-CY8Pgu3B.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6])),
      ...
      },
      {
        ...
        name: 'Register',
        component: () =>
          Ke(() => import('./RegisterView-D-CRtYk6.js'), __vite__mapDeps([7, 1, 2, 3, 4, 5, 8])),
      ...
      },
      {
        ...
        component: () =>
          Ke(
            () => import('./AiHomePage-h-_giYqD.js'),
            __vite__mapDeps([9, 10, 3, 11, 12, 13, 14, 15])
          ),
      ...
      },
      {
        ...
        component: () =>
          Ke(
            () => import('./PersonalCenter-z1nDyoP9.js'),
            __vite__mapDeps([16, 13, 3, 14, 10, 17])
          ),
      ...
      },
      {
        ...
        name: 'Profile',
        component: () =>
          Ke(() => import('./ProfileView-D6tgGxdw.js'), __vite__mapDeps([18, 1, 2, 3, 19])),
        meta: { title: '设置', requiresAuth: !0 }
      },
      {
        path: '/workspace',
        component: () =>
          Ke(() => import('./TabLayout-BfA-3VPv.js'), __vite__mapDeps([20, 11, 12, 21])),
        meta: { requiresAuth: !0 },
        ...
        children: [
          {
            ...
            name: 'search',
            component: () =>
              Ke(() => import('./SearchView-gVr_iwJR.js'), __vite__mapDeps([22, 23])),
            meta: { title: '搜索' }
          },
          {
            path: 'image',
            name: 'image',
            component: () => Ke(() => import('./ImageView-glHrQP7m.js'), __vite__mapDeps([24, 25])),
            meta: { title: '绘图' }
          },
          {
            path: 'files',
            name: 'files',
            component: () => Ke(() => import('./FilesView-f7KoC1Gh.js'), __vite__mapDeps([26, 27])),
            meta: { title: '文件' }
          },
          {
            path: 'code',
            name: 'code',
            component: () => Ke(() => import('./CodeView-C0GKzrp0.js'), __vite__mapDeps([28, 29])),
            meta: { title: '代码' }
          },
          {
            path: 'history',
            name: 'history',
            component: () =>
              Ke(() => import('./HistoryView-EWaoPA11.js'), __vite__mapDeps([30, 13, 3, 31])),
            meta: { title: '历史' }
          },
          {
            path: 'settings',
            name: 'settings',
            component: () =>
              Ke(() => import('./SettingsView-CXJyO5fs.js'), __vite__mapDeps([32, 33])),
            meta: { title: '设置' },
            children: [
              {
                path: 'providers',
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderList-BwZja76Y.js'),
                    __vite__mapDeps([34, 35, 36, 3, 37])
                  ),
                meta: { title: '供应商管理' }
              },
              {
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderForm-BcjiQP0m.js'),
                    __vite__mapDeps([38, 35, 36, 3, 39])
                  ),
                meta: { title: '新增供应商' }
              },
              {
                ...
                component: () =>
                  Ke(
                    () => import('./ProviderDetail-B5Ot1rbI.js'),
                    __vite__mapDeps([40, 35, 36, 3, 41])
                  ),
                meta: { title: '供应商详情' }
              },
              {
              ...
              },
              {
                ...
                name: 'model-manager',
                component: () =>
                  Ke(() => import('./ModelManager-6FgyDDnO.js'), __vite__mapDeps([42, 10, 3, 43])),
                meta: { title: '模型管理' }
              },
              {
                path: 'tools',
                name: 'tool-manager',
                component: () =>
                  Ke(() => import('./ToolManager-UgY28yN4.js'), __vite__mapDeps([44, 3, 45])),
                meta: { title: '工具管理' }
              },
              {
                path: 'devices',
                name: 'device-manager',
                component: () =>
                  Ke(() => import('./DeviceManager-CBen3s4w.js'), __vite__mapDeps([46, 3, 2, 47])),
                meta: { title: '设备连接' }
              },
              {
                path: 'ai-resources',
                ...
                component: () =>
                  Ke(
                    () => import('./AiResourcesView-CjCBDN26.js'),
                    __vite__mapDeps([48, 3, 36, 49])
                  ),
                meta: { title: 'AI 资源' }
              },
              {
                ...
                name: 'org-manager',
                component: () =>
                  Ke(() => import('./OrgView-CxYy2a63.js'), __vite__mapDeps([50, 3, 1, 2, 51])),
                meta: { title: '组织管理' }
              },
              {
                path: 'api-keys',
                name: 'api-keys',
                component: () =>
                  Ke(() => import('./ApiKeysView-CnmwbuDo.js'), __vite__mapDeps([52, 3, 53])),
                meta: { title: 'API Key' }
              }
            ]
          }
