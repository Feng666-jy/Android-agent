...
import { u as S } from './provider-B6_1_C4o.js'
...
const N = { class: 'provider-list' },
  ...
  q = { class: 'provider-card__info' },
  J = { class: 'provider-card__name-row' },
      ...
      return (i, t) => (
        ...
        n('div', N, [
          e('header', { class: 'provider-list__header' }, [
            e('button', { class: 'provider-list__back', 'aria-label': '返回', onClick: y }, [
              ...(t[3] ||
                (t[3] = [
                  e(
                    'svg',
          ...
          e('div', j, [
            e('label', z, [
              e('input', { type: 'checkbox', checked: d.value, onChange: m }, null, 40, T),
