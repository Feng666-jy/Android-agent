...
import { u as I } from './model-DfDNvLOK.js'
import './request-eyLhzUlJ.js'
const T = { class: 'model-manager' },
  A = { class: 'model-manager__header' },
  q = { key: 0, class: 'model-manager__group-form' },
  U = { class: 'model-manager__search' },
  W = ['value'],
  K = { class: 'model-manager__toolbar' },
  O = { class: 'model-manager__sort' },
  Q = { key: 0, class: 'model-manager__sort-menu' },
  H = ['onClick'],
  J = { class: 'model-manager__groups' },
  P = ['onClick'],
      ...
      return (a, t) => (
        ...
        n('div', T, [
          ...
          e('div', K, [
            ...
            e(
              'button',
              { class: 'model-manager__btn-text', onClick: F },
              d(
          ...
          s.value.size > 0
            ? (r(),
              n('div', R, [
                ...
                e(
                  'button',
                  { class: 'model-manager__action-btn', onClick: t[5] || (t[5] = o => w(null)) },
                  ' 移至未分组 '
                ),
                (r(!0),
                n(
                  ...
                  n(
                    ...
                    [
                      e('label', te, [
                        e(
                          'input',
                          { type: 'checkbox', checked: s.value.has(o.id), onChange: v => z(o.id) },
                          null,
                          40,
                          le
                        )
  ...
  ye = V(he, [['__scopeId', 'data-v-69a11a55']])
