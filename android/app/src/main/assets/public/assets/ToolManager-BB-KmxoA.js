...
import { r as w } from './request-eyLhzUlJ.js'
const y = {
    overview() {
  ...
  je = { class: 'tool-manager__item-title' },
  Be = { class: 'tool-manager__item-desc' },
  Oe = { class: 'tool-manager__item-actions' },
  Ae = ['disabled', 'onClick'],
  Fe = ['onClick'],
  Ee = { key: 5, class: 'tool-manager__panel' },
  Ie = { class: 'tool-manager__row-actions' },
  Le = { key: 0, class: 'tool-manager__form' },
                ...
                P.value
                  ? (s(),
                    l('div', ie, [
                      ...
                      e('button', { class: 'tool-manager__btn-primary', onClick: I }, '创建')
                    ]))
                  : _('', !0),
                e('ul', ue, [
                  (s(!0),
