const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/index-DTPmbI92.js', 'assets/index-CprlDezj.css'])
) => i.map(i => d[i])
import {
  d as I,
  c as _,
...
import { m as j, u as me } from './model-CO2euHd2.js'
import { B as fe } from './BottomToolbar-DEwv6Nne.js'
import { m as ke, a as R } from './agent-CF4HRCsr.js'
import { u as ge } from './conversation-CHD199ET.js'
    ...
    setup(c, { emit: p }) {
      ...
      return (v, n) => (
        ...
        _(
          ...
          [
            e('span', Ve, g(c.model.displayName), 1),
            c.selected
              ? (u(),
                _('svg', Ee, [
...
const je = S(Ne, [
                    ...
                    _(
                      ...
                      [
                        e('div', Oe, [
                          ...
                          c.models.length === 0 ? (u(), L(je, { key: 0 })) : x('', !0)
                        ])
                      ],
                      512
                    ))
      ...
      async function m() {
        if (!(i.value.length > 0)) {
          ...
          try {
            let y
            ;(v.provider === 'deepseek'
              ? (y = await j.getDeepSeekModels())
              : v.provider === 'claude'
                ? (y = await j.getClaudeModels())
                : (y = await j.getChatGPTModels()),
              (i.value = y.data || []))
          } catch {
            i.value = []
          } finally {
            ...
            e(
              ...
              [
                ...
                _(
                  ...
                  [...(V[0] || (V[0] = [e('polyline', { points: '6 9 12 15 18 9' }, null, -1)]))],
                  2
                ))
              ],
              10,
  ...
  Vt = { class: 'approval-item__actions' },
  Et = ['disabled', 'onClick'],
  Pt = ['disabled', 'onClick'],
  Rt = I({
    ...
    setup(c, { expose: p, emit: r }) {
      ...
      async function U(d, o) {
        ...
        ;(P(),
          ...
          (h.value = !1))
        const a = ke()
        ;((m = new AbortController()), D(a), (b = setInterval(() => D(a), 1500)))
        try {
          const w = await R.run(
            {
              modelId: o,
          ...
          if ((V(), (h.value = !1), w.code === 0)) {
            const { runId: f, ...N } = w.data
            ;((s.value = N),
              (n.value = 'done'),
              (t.value = (($ = N.state) == null ? void 0 : $.error) || N.error || ''),
              v('done', { runId: f, task: d, modelId: o, status: N.status }))
          }
        } catch (w) {
          if (
            (V(),
  ...
  Nt = S(Rt, [['__scopeId', 'data-v-5e55423c']]),
  Dt = { class: 'page' },
  Lt = { class: 'content' },
  Ft = I({
    __name: 'AiHomePage',
    setup(c) {
      ...
      function T(m) {
        if (!l.value) {
          ve(
            async () => {
              const { showToast: C } = await import('./index-DTPmbI92.js').then(y => y.N)
              return { showToast: C }
            },
            __vite__mapDeps([0, 1])
      ...
      return (m, b) => (
        ...
        _('div', Dt, [
          ...
          e('main', Lt, [M(Nt, { ref_key: 'runPanel', ref: n, onDone: A }, null, 512)]),
